...
- `targetType=MyType` to get the permissions targeting selected type(note: the field support complex entity type selection as defined in section 4.17 of the specification)
- `targetScopeQ=/my/Scope` to get the permissions targeting selected scope(note: the field support complex scope query as defined in section 4.19 of the specification)
